...
with open("./datasets/files/2022-08_GSEC_Listing_of_People_Groups.csv", newline='') as csvfile:
    ...
    for row in reader:
        ...
        if not all(i is '' for i in row):
            ...
            cur.execute("insert into gsec_listing_of_people_groups (peid, affinity_bloc, people_cluster, continent, sub_continent, country, country_of_origin, people_group, global_status_of_evangelical_christianity, evangelical_engagement, population, dispersed, rol, language, religion, nomadic, nomadic_type, nomadic_description, written_scripture, jesus_film, radio_broadcast, gospel_recording, audio_scripture, gospel_films, the_hope, resources, physical_exertion, freedom_index, government_restrictions_index, social_hostilities_index, threat_level, rop1, rop2, rop3, people_name, genc, fips, fips_of_origin, latitude, longitude, imb_affinity_group, not_engaged_anywhere, spi, strategic_priority_index, population_layer) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
